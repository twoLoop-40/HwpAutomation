...
class HwpClient:
    """
    HWP COM client wrapper with type-safe state management.

    Based on the Idris2 formal specification in Specs/HwpMCP.idr.
    Ensures safe state transitions and parameter validation.
    """
